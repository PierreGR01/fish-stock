            ...
            <div key={step.id} style={{ display: 'flex', alignItems: 'center' }}>
              {i > 0 && (
                <div style={{
                  width: 32,
                  height: 1,
                  background: state === 'todo' ? 'var(--ink-500)' : 'var(--ice-border)',
                }} />
              )}
              <div style={{
                display: 'flex',
                ...
                <div style={{
                  ...
                  fontWeight: 600,
                  background: state === 'active' ? 'var(--ice)'
                    : state === 'done' ? 'var(--signal-ok)'
                    : 'var(--ink-500)',
                  color: state === 'active' ? 'var(--ink-900)'
                    : state === 'done' ? 'var(--ink-900)'
                    : 'var(--text-lo)',
                  flexShrink: 0,
                }}>
                  {state === 'done' ? '✓' : step.num}
                ...
                <span style={{
                  ...
                  color: state === 'active' ? 'var(--text-hi)'
                    : state === 'done' ? 'var(--text-mid)'
                    : 'var(--text-lo)',
                }}>
                  {step.label}
                </span>
